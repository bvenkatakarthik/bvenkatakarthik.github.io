...
The goal is to study higher derivatives of maps ${ f : U (\subseteq E \text{ open}) \to F . }$ 
...
The goal is to study local invertibility of functions. 

Let ${ f : U (\subseteq E \text{ open}) \to F }$ be a ${ C ^p }$ map and ${ x _0 \in U . }$ Suppose the derivative of ${ f }$ at ${ x _0 }$ is invertible. We can ask ourselves: Is ${ f }$ locally invertible at ${ x _0 }$? 
...
$${  \mathscr{V} \longrightarrow L(F, F) , }$$ 

$${ x   \longmapsto \partial _2 \hat{f} (x, g(x))  }$$ 
