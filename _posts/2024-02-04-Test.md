...
> P vs NP is a millennium prize problem: https://www.claymath.org/wp-content/uploads/2022/06/pvsnp.pdf. Geometric Complexity Theory is a research program aimed at resolving this is: https://en.m.wikipedia.org/wiki/Geometric_complexity_theory. 
...
The notion of accepting a string is modified accordingly. An NFA ${ N = (Q, \Sigma, \delta, q _0, F) }$ **accepts string** ${ w = w _1 \ldots w _n }$ (each ${ w _i \in \Sigma _{{\color{red}{\varepsilon}}} }$) if there is a sequence of states ${ r _0, \ldots, r _n \in Q }$ such that: 
* ${ r _0 = q _0 }$ 
* ${ r _i \, {\color{red}{\in}} \, \delta(r _{i-1}, w _i) }$ for ${ 1 \leq i \leq n }$ 
* ${ r _n \in F }.$ 
...
An example of a context free grammar (CFG) is ${ G _1 }$ given by: $${ S \to 0S1 }$$ $${ S \to R }$$ $${ R \to \varepsilon. }$$ 
