...
We also call ${ \lVert A \rVert _2 }$ as the spectral norm of ${ A .}$ Similarly, using SVD ${ A = U \Sigma V ^T ,}$  
...
(This gives a more natural proof for ${ \lVert A \rVert _F \geq \lVert A \rVert _2 .}$) 
...
Consider ${ Y = U I _{M \times N} V ^T , }$ where ${ I _{M \times N} }$ is the ${ M \times N }$ matrix with ${ 1 }$s on the diagonal and ${ 0 }$s everywhere else. Now ${ \sigma _1 (Y) = 1 }$ and 
