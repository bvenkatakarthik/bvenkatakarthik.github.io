...
[Continuous linear maps](#1); [Differentiation](#2); [Differentiation of maps ${ \mathbb{R} ^n \to \mathbb{R} ^m }$](#3)  

The broad goal is to study linear approximations to functions. 
...
Let ${ E, F }$ be normed vector spaces and ${ \lambda : E \to F }$ a linear map. We can ask ourselves: When is ${ \lambda }$ continuous? 
...
The goal is to study continuous linear approximations to functions.
...
We can ask ourselves: If a map ${ f : U (\subseteq E \text{ open}) \to F }$ is differentiable at ${ p \in U }$ is it continuous at ${ p }$? 
...
We can ask ourselves: If a map ${ f : U (\subseteq E \text{ open}) \to F }$ is differentiable at ${ p \in U }$ is the derivative at ${ p }$ unique? 
...
We can ask ourselves: How does the derivative behave with the usual operations on functions? 
...
Let ${ f : U (\subseteq \mathbb{R} ^n \text{ open}) \to \mathbb{R} ^m }$ and ${ x \in U . }$ We can ask ourselves: What is the derivative of ${ f }$ at ${ x }$? 
