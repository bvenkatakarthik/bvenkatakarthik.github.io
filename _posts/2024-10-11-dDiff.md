...
The goal is to study the zero sets of ${ C ^P }$ maps ${ f : U (\subseteq \mathbb{R} ^n \text{ open}) \to \mathbb{R} ^m . }$ 
...
The goal is to study the tangential spaces and normal spaces of a manifold.
...
$${ T _p f : T _p M \longrightarrow T _{f(p)} \mathbb{R} = \lbrace f(p) \rbrace \times \mathbb{R},  }$$ 
...
Therefore the maximum point ${ x _1 \in S ^{n-1} }$ is an eigenvector with eigenvalue ${ \lambda _1, }$ and at this point 

$${ F(x _1) = (x _1 \, \vert \, A x _1) = (x _1 \, \vert \, \lambda _1 x _1) = \lambda _1 .  }$$ 

${ \boxed{2} }$  Secondly, let ${ h _{(2)} (x) := (\lVert x \rVert ^2 - 1, 2(x _1 \, \vert \, x) ) .  }$  The regular fiber ${ M _{(2)} = h _{(2)} ^{-1} (0) = S ^{n-1} \cap \text{span}(x _1) ^{\perp} }$ is compact, so ${ F \vert _{M _{(2)}} }$ has a maximum point ${ x _2 \in M _{(2)} .}$ Now by Lagrange multipliers, there exist unique ${ \lambda _{(2), 1}, \lambda _{(2), 2} \in \mathbb{R} }$ such that 
...
Therefore the maximum point ${ x _2 \in S ^{n-1} \cap \text{span}(x _1) ^{\perp} }$ is an eigenvector with eigenvalue ${ \lambda _{(2), 1} , }$ and at this point 
...
Therefore the maximum point ${ x _n \in S ^{n-1} \cap \text{span}(x _1, \ldots, x _{n-1}) ^{\perp} }$ is an eigenvector with eigenvalue ${ \lambda _{(n), 1}, }$ and at this point 

$${ F(x _n) = (x _n \, \vert \, A x _n) = (x _n \, \vert \, \lambda _{(n), 1} x _n) = \lambda _{(n), 1} .  }$$ 
